...
data_path = 's3://ai4e-ap-southeast-1-dev-s3-data-landing/nhantran/data/2024-09-01.csv' # Cloud path
destination_path = 's3://ai4e-ap-southeast-1-dev-s3-data-landing/data_test/nhantrandemo_data'
...
SELECT COUNT(DISTINCT struct(username, email)) AS distinct_username_email_pairs
FROM footprint_view;
''')
